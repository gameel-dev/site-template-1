...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: company
      ? `About Us | We Buy Houses Fast | ${company}`
      : "About Us | We Buy Houses Fast",
    description: company
      ? `Learn about ${company}. Local, family-owned real estate investors. We buy houses as-is and help you sell fast with no hassle.`
      : "Learn about us. Local, family-owned real estate investors. We buy houses as-is and help you sell fast with no hassle.",
  };
}
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6">
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <p className="text-ink-muted leading-relaxed mb-8">
                We buy houses from sellers who are looking to sell their home fast for cash. <CompanyName /> team can help you sell your house fast no matter where the house is located, no matter its condition. With our ability to directly purchase houses and make cash offers, we create a very quick and hassle-free transaction.
              </p>
              ...
              <h2 className="text-xl font-semibold text-ink mt-10 mb-4">
                How does <CompanyName /> help the sellers?
              </h2>
              <ul className="list-disc pl-6 text-ink-muted space-y-2 mb-8">
